...
export BITWUZLA_COMMIT_HASH="fc8610fcfad12902d4eae4741ceb386524cf9b10"
export RACKET_FMT_COMMIT_HASH="7d0a3dfff3a6cacfb59972a56d476556f89a0b1b"
# TODO(@gussmith23): change this back to Yosys mainline when PR merges.
export YOSYS_URL="https://github.com/gussmith23/yosys"
export YOSYS_COMMIT_HASH="a1d68fe3bcddbf452832613822fce0235980b078"

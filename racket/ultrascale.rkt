...
here-string-delimiter
     ...
     module-name
     (bitvector->natural lut-memory-a)
     (if (bitvector->bool (bit 5 mask-a)) "1'b1" "input_a[5]")
     (if (bitvector->bool (bit 4 mask-a)) "1'b1" "input_a[4]")
     (if (bitvector->bool (bit 3 mask-a)) "1'b1" "input_a[3]")
     (if (bitvector->bool (bit 2 mask-a)) "1'b1" "input_a[2]")
     (if (bitvector->bool (bit 1 mask-a)) "1'b1" "input_a[1]")
     (if (bitvector->bool (bit 0 mask-a)) "1'b1" "input_a[0]")
     (bitvector->natural lut-memory-b)
     (if (bitvector->bool (bit 5 mask-b)) "1'b1" "input_b[5]")
     (if (bitvector->bool (bit 4 mask-b)) "1'b1" "input_b[4]")
     (if (bitvector->bool (bit 3 mask-b)) "1'b1" "input_b[3]")
     (if (bitvector->bool (bit 2 mask-b)) "1'b1" "input_b[2]")
     (if (bitvector->bool (bit 1 mask-b)) "1'b1" "input_b[1]")
     (if (bitvector->bool (bit 0 mask-b)) "1'b1" "input_b[0]")
     (bitvector->natural lut-memory-c)
     (if (bitvector->bool (bit 5 mask-c)) "1'b1" "input_c[5]")
     (if (bitvector->bool (bit 4 mask-c)) "1'b1" "input_c[4]")
     (if (bitvector->bool (bit 3 mask-c)) "1'b1" "input_c[3]")
     (if (bitvector->bool (bit 2 mask-c)) "1'b1" "input_c[2]")
     (if (bitvector->bool (bit 1 mask-c)) "1'b1" "input_c[1]")
     (if (bitvector->bool (bit 0 mask-c)) "1'b1" "input_c[0]")
     (bitvector->natural lut-memory-d)
     (if (bitvector->bool (bit 5 mask-d)) "1'b1" "input_d[5]")
     (if (bitvector->bool (bit 4 mask-d)) "1'b1" "input_d[4]")
     (if (bitvector->bool (bit 3 mask-d)) "1'b1" "input_d[3]")
     (if (bitvector->bool (bit 2 mask-d)) "1'b1" "input_d[2]")
     (if (bitvector->bool (bit 1 mask-d)) "1'b1" "input_d[1]")
     (if (bitvector->bool (bit 0 mask-d)) "1'b1" "input_d[0]")
     (bitvector->natural lut-memory-e)
     (if (bitvector->bool (bit 5 mask-e)) "1'b1" "input_e[5]")
     (if (bitvector->bool (bit 4 mask-e)) "1'b1" "input_e[4]")
     (if (bitvector->bool (bit 3 mask-e)) "1'b1" "input_e[3]")
     (if (bitvector->bool (bit 2 mask-e)) "1'b1" "input_e[2]")
     (if (bitvector->bool (bit 1 mask-e)) "1'b1" "input_e[1]")
     (if (bitvector->bool (bit 0 mask-e)) "1'b1" "input_e[0]")
     (bitvector->natural lut-memory-f)
     (if (bitvector->bool (bit 5 mask-f)) "1'b1" "input_f[5]")
     (if (bitvector->bool (bit 4 mask-f)) "1'b1" "input_f[4]")
     (if (bitvector->bool (bit 3 mask-f)) "1'b1" "input_f[3]")
     (if (bitvector->bool (bit 2 mask-f)) "1'b1" "input_f[2]")
     (if (bitvector->bool (bit 1 mask-f)) "1'b1" "input_f[1]")
     (if (bitvector->bool (bit 0 mask-f)) "1'b1" "input_f[0]")
     (bitvector->natural lut-memory-g)
     (if (bitvector->bool (bit 5 mask-g)) "1'b1" "input_g[5]")
     (if (bitvector->bool (bit 4 mask-g)) "1'b1" "input_g[4]")
     (if (bitvector->bool (bit 3 mask-g)) "1'b1" "input_g[3]")
     (if (bitvector->bool (bit 2 mask-g)) "1'b1" "input_g[2]")
     (if (bitvector->bool (bit 1 mask-g)) "1'b1" "input_g[1]")
     (if (bitvector->bool (bit 0 mask-g)) "1'b1" "input_g[0]")
     (bitvector->natural lut-memory-h)
     (if (bitvector->bool (bit 5 mask-h)) "1'b1" "input_h[5]")
     (if (bitvector->bool (bit 4 mask-h)) "1'b1" "input_h[4]")
     (if (bitvector->bool (bit 3 mask-h)) "1'b1" "input_h[3]")
     (if (bitvector->bool (bit 2 mask-h)) "1'b1" "input_h[2]")
     (if (bitvector->bool (bit 1 mask-h)) "1'b1" "input_h[1]")
     (if (bitvector->bool (bit 0 mask-h)) "1'b1" "input_h[0]")
     ; Carry in.
     (if (bitvector->bool cin) "1'b1" "1'b0")
     ; Output assignment.
     ; TODO this isn't exactly right...
     (mux-codegen-helper mux-selector-h "7")
     (mux-codegen-helper mux-selector-g "6")
     (mux-codegen-helper mux-selector-f "5")
     (mux-codegen-helper mux-selector-e "4")
     (mux-codegen-helper mux-selector-d "3")
     (mux-codegen-helper mux-selector-c "2")
     (mux-codegen-helper mux-selector-b "1")
     (mux-codegen-helper mux-selector-a "0")))

  ...
  (match-let* ([(ultrascale-plus-dsp48e2 A
    ...
    (define dsp-expr
      (interpret-xilinx-ultrascale-plus-dsp48e2
       ...
       #:unnamed-input-300 (bv->signal unnamed-input-331)
       #:unnamed-input-439 (bv->signal unnamed-input-488)
       #:unnamed-input-677 (bv->signal unnamed-input-750)
       #:unnamed-input-727 (bv->signal unnamed-input-806)
       #:unnamed-input-771 (bv->signal unnamed-input-850)))

...
(define
  ...
  (list
    (cons "DSP48E2" (DSP48E2_Outputs-XOROUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-UNDERFLOW outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-PCOUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-PATTERNDETECT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-PATTERNBDETECT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-P outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-OVERFLOW outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-MULTSIGNOUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-CARRYOUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-CARRYCASCOUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-BCOUT outputs))
    (cons "DSP48E2" (DSP48E2_Outputs-ACOUT outputs))))

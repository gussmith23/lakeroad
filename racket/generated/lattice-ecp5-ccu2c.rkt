...
(define lattice-ecp5-ccu2c
  (λ (#:A0 (A0 (bv->signal (constant 'A0 (bitvector 1))))
      #:A1 (A1 (bv->signal (constant 'A1 (bitvector 1))))
      #:B0 (B0 (bv->signal (constant 'B0 (bitvector 1))))
      #:B1 (B1 (bv->signal (constant 'B1 (bitvector 1))))
      #:C0 (C0 (bv->signal (constant 'C0 (bitvector 1))))
      #:C1 (C1 (bv->signal (constant 'C1 (bitvector 1))))
      #:CIN (CIN (bv->signal (constant 'CIN (bitvector 1))))
      #:D0 (D0 (bv->signal (constant 'D0 (bitvector 1))))
      #:D1 (D1 (bv->signal (constant 'D1 (bitvector 1))))
      #:INIT0 (INIT0 (bv->signal (constant 'INIT0 (bitvector 16))))
      #:INIT1 (INIT1 (bv->signal (constant 'INIT1 (bitvector 16))))
      #:INJECT1_0 (INJECT1_0 (bv->signal (constant 'INJECT1_0 (bitvector 1))))
      #:INJECT1_1 (INJECT1_1 (bv->signal (constant 'INJECT1_1 (bitvector 1)))))
    (let* ([merged-input-state-hash (list)]
           [init-hash (list)]
           [btor1 (bitvector 1)]
           [btor2 A0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state A0))]
           [btor3 A1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state A1))]
           [btor4 B0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state B0))]
           [btor5 B1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state B1))]
           [btor6 C0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state C0))]
           [btor7 C1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state C1))]
           [btor8 CIN]
           [merged-input-state-hash (append merged-input-state-hash (signal-state CIN))]
           [btor9 D0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state D0))]
           [btor10 D1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state D1))]
           [btor11 (bitvector 16)]
           [btor12 INIT0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state INIT0))]
           [btor13 INIT1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state INIT1))]
           [btor14 INJECT1_0]
           [merged-input-state-hash (append merged-input-state-hash (signal-state INJECT1_0))]
           [btor15 INJECT1_1]
           [merged-input-state-hash (append merged-input-state-hash (signal-state INJECT1_1))]
           [btor16 (bitvector 8)]
           ...
           [btor40 (signal (bvand (signal-value btor31) (signal-value btor39)) (list))]
           ...
           [btor61 (signal (bvand (signal-value btor53) (signal-value btor60)) (list))]
           [btor62 (signal (bvand (signal-value btor52) (signal-value btor8)) (list))]
           [btor63 (signal (bvor (signal-value btor61) (signal-value btor62)) (list))]
           [btor64 (signal (bvand (signal-value btor30) (signal-value btor63)) (list))]
           [btor65 (signal (bvor (signal-value btor40) (signal-value btor64)) (list))]
           [btor67 (if (bitvector->bool (signal-value btor14)) btor38 btor8)]
           [btor68 (signal (bvxor (signal-value btor52) (signal-value btor67)) (list))]
           [btor70 (if (bitvector->bool (signal-value btor15)) btor38 btor63)]
           [btor71 (signal (bvxor (signal-value btor30) (signal-value btor70)) (list))]
           [btor73 (bv->signal (zero-extend (signal-value btor56) (bitvector 2)) btor56)]
           [btor74 (signal (extract 3 0 (signal-value btor12)) (signal-state btor12))]
           [btor75 (bv->signal (zero-extend (signal-value btor74) (bitvector 4)) btor74)]
           [btor76 (bv->signal (zero-extend (signal-value btor59) (bitvector 1)) btor59)]
           ...
           [btor80 (signal (extract 3 0 (signal-value btor13)) (signal-state btor13))]
           [btor81 (bv->signal (zero-extend (signal-value btor80) (bitvector 4)) btor80)]
           [btor82 (bv->signal (zero-extend (signal-value btor37) (bitvector 1)) btor37)]
           ...
           [btor88 (bv->signal (zero-extend (signal-value btor12) (bitvector 16)) btor12)]
           [btor89 (bv->signal (zero-extend (signal-value btor52) (bitvector 1)) btor52)]
           ...
           [btor97 (bv->signal (zero-extend (signal-value btor13) (bitvector 16)) btor13)]
           [btor98 (bv->signal (zero-extend (signal-value btor30) (bitvector 1)) btor30)]
      ...
      (list (cons 'COUT (signal (signal-value btor65) (list)))

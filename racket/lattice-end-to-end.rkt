...
(module+ test
  ...
  ; (check-true (end-to-end-test (bvand a5 b5)))
  ; (check-true (end-to-end-test (bvxor a5 b5)))
  ; (check-true (end-to-end-test (bvor a5 b5)))
  ; (check-true (end-to-end-test (bvadd a5 b5)))
  ; (check-true (end-to-end-test (bvsub a5 b5)))
  ; (check-true (end-to-end-test (bithack1 a5 b5)))
  ; (check-true (end-to-end-test (bithack2 a5 b5)))
  ; (check-true (end-to-end-test (bithack3 a5 b5)))
  ; (check-true (end-to-end-test a5))
  ; (check-true (end-to-end-test (bvmul a5 (bv 0 5))))
  ; (check-true (end-to-end-test (bvmul a5 (bv 1 5))))

           ...
           [btor258
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state258)
                       (bv->signal (hash-ref init-hash 'state258))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state258)
           ...
           [btor259
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state259)
                       (bv->signal (hash-ref init-hash 'state259))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state259)
           ...
           [btor260
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state260)
                       (bv->signal (hash-ref init-hash 'state260))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state260)
           ...
           [btor272
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state272)
                       (bv->signal (hash-ref init-hash 'state272))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state272)
           ...
           [btor274
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state274)
                       (bv->signal (hash-ref init-hash 'state274))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state274)
           ...
           [btor357
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state357)
                       (bv->signal (hash-ref init-hash 'state357))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state357)
           ...
           [btor358
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state358)
                       (bv->signal (hash-ref init-hash 'state358))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state358)
           ...
           [btor359
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state359)
                       (bv->signal (hash-ref init-hash 'state359))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state359)
           ...
           [btor394
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state394)
                       (bv->signal (hash-ref init-hash 'state394))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state394)
           ...
           [btor395
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state395)
                       (bv->signal (hash-ref init-hash 'state395))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state395)
           ...
           [btor396
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state396)
                       (bv->signal (hash-ref init-hash 'state396))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state396)
           ...
           [btor532
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state532)
                       (bv->signal (hash-ref init-hash 'state532))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state532)
           ...
           [btor533
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state533)
                       (bv->signal (hash-ref init-hash 'state533))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state533)
           ...
           [btor534
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state534)
                       (bv->signal (hash-ref init-hash 'state534))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state534)
           ...
           [btor627
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state627)
                       (bv->signal (hash-ref init-hash 'state627))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state627)
           ...
           [btor628
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state628)
                       (bv->signal (hash-ref init-hash 'state628))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state628)
           ...
           [btor877
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state877)
                       (bv->signal (hash-ref init-hash 'state877))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state877)
           ...
           [btor878
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state878)
                       (bv->signal (hash-ref init-hash 'state878))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state878)
           ...
           [btor879
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state879)
                       (bv->signal (hash-ref init-hash 'state879))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state879)
           ...
           [btor936
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state936)
                       (bv->signal (hash-ref init-hash 'state936))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state936)
           ...
           [btor937
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state937)
                       (bv->signal (hash-ref init-hash 'state937))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state937)
           ...
           [btor938
            (let* ([state-value
                    (cond
                      ...
                      [(hash-has-key? init-hash 'state938)
                       (bv->signal (hash-ref init-hash 'state938))]
                      [else
                       (log-warning
                        "state ~a with no initial value, init to 0, this may not be correct in the long term"
                        'state938)

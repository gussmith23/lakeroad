   ...
   (normal?
    (with-vc (with-terms
              (begin
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut2 (lr:bv lut-init-0)
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut2 (lr:bv lut-init-1)
                                                  (lr:concat (lr:list (list (lr:bv (bv->signal B))
                                                                            (lr:bv (bv->signal A))))))
                               (lr:integer 0))
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut2 (lr:bv lut-init-2)
                                                  (lr:concat (lr:list (list (lr:bv (bv->signal B))
                                                                            (lr:bv (bv->signal A))))))
                               (lr:integer 0))
   ...
   (normal?
    (with-vc (with-terms
              (begin
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut4 (lr:bv lut-init-0)
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut4 (lr:bv lut-init-1)
                                                  (lr:concat (lr:list (list (lr:bv (bv->signal D))
                                                                            (lr:bv (bv->signal C))
                                                                            (lr:bv (bv->signal B))
                                                                            (lr:bv (bv->signal A))))))
                ...
                (add-to-simulate
                 (to-simulate
                  (lr:list-ref (lattice-ecp5-lut4 (lr:bv lut-init-2)
                                                  (lr:concat (lr:list (list (lr:bv (bv->signal D))
                                                                            (lr:bv (bv->signal C))
                                                                            (lr:bv (bv->signal B))
                                                                            (lr:bv (bv->signal A))))))

...
(module+ test
  ...
  (for ([sz (list 1 2 4 8 16 32 64)])
    (test-begin (define-symbolic l0 l1 (bitvector sz))
                ...
                (check-true (end-to-end-test (bvnot l0)))
                ...
                (check-true (end-to-end-test (bvmul l0 (bv 0 sz))))
                (check-true (end-to-end-test (bvmul l0 (bv 1 sz))))
                (check-true (end-to-end-test (bvmul l0 (bv 2 sz))))
                (check-true (end-to-end-test (circt-comb-shl l0 (bv 0 sz))))
                (check-true (end-to-end-test (circt-comb-shl l0 (bv 1 sz)))))))

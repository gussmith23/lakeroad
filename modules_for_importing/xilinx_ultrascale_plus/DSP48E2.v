...
module DSP48E2 (
  ...
  always @(CARRYINSEL_mux or CARRYCASCIN_in or MULTSIGNIN_in or OPMODE_mux) begin
    if (CARRYINSEL_mux == 3'b010) begin
      if (!((MULTSIGNIN_in === 1'b0) || (cci_drc_msg == 1'b1) ||
             ((OPMODE_mux == 9'b001001000) && !(MULTSIGNIN_in === 1'b0)) ||
      ...
      if (!((MULTSIGNIN_in === 1'b0) || (OPMODE_mux[3:0] != 4'b0101))) begin
      ...
      if (!((MULTSIGNIN_in === 1'b0) || (cis_drc_msg == 1'b1) || (OPMODEREG_BIN == 1'b1))) begin
